...
(* DEFS USING FOLDR *)
	...
	[ DEFUN   MAP  [lis fun]
	    FOLDR lis 0 [LAMBDA [l r] CONS [fun l] r] ]
...
(* DEFS USING FOLDR2 *)
	[ DEFUN   ZIP  [l1 l2]
	    FOLDR2 l1 l2 0 [LAMBDA [x y z] CONS [PAIR x y] z] ]
	[ ZIP  NAMELIST  [QUOTE [Smith Jones Robinson]] ]

	[ DEFUN   WEAVE  [l1 l2]
	    FOLDR2 l1 l2 0 [LAMBDA [x y z] CONS x [CONS y z]] ]
	...
	[ DEFUN   MAP2  [l1 l2 f]
	    FOLDR2 l1 l2 0 [LAMBDA [x y z] CONS [f x y] z]  ]
	[ MAP2 [QUOTE [1 2 3]] [QUOTE [1 10 100]]
	       [LAMBDA [x y] * x y] ]

(* DEFS USING RECFOLDR *)
	[ DEFUN   RECFLATTEN [lis]
	    RECFOLDR lis 0 [LAMBDA [x l] CONS x l] ]
