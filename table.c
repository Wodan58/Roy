...
{ "all_set", "A [B]  ->  X", "Applies test B to members of aggregate A, X = true if all pass.\n" },
{ "all_str", "A [B]  ->  X", "Applies test B to members of aggregate A, X = true if all pass.\n" },
...
{ "app1", "X [P]  ->  R", "Executes P, pushes result R on stack.\n" },
...
{ "at_set", "A I  ->  X", "X (= A[I]) is the member of A at position I.\n" },
{ "at_str", "A I  ->  X", "X (= A[I]) is the member of A at position I.\n" },
...
{ "concat_set", "S T  ->  U", "Sequence U is the concatenation of sequences S and T.\n" },
...
{ "cons_set", "X A  ->  B", "Aggregate B is A with a new member X (first member for sequences).\n" },
...
{ "drop_set", "A N  ->  B", "Aggregate B is the result of deleting the first N elements of A.\n" },
{ "drop_str", "A N  ->  B", "Aggregate B is the result of deleting the first N elements of A.\n" },
...
{ "enconcat_set", "X S T  ->  U", "Sequence U is the concatenation of sequences S and T\nwith X inserted between S and T (== swapd cons concat).\n" },
...
{ "filter_set", "A [B]  ->  A1", "Uses test B to filter aggregate A producing sametype aggregate A1.\n" },
{ "filter_str", "A [B]  ->  A1", "Uses test B to filter aggregate A producing sametype aggregate A1.\n" },
{ "first", "A  ->  F", "F is the first member of the non-empty aggregate A.\n" },
{ "first_set", "A  ->  F", "F is the first member of the non-empty aggregate A.\n" },
{ "first_str", "A  ->  F", "F is the first member of the non-empty aggregate A.\n" },
{ "float", "R  ->  B", "Tests whether R is a float.\n" },
{ "floor", "F  ->  G", "G is the floor of F.\n" },
{ "fmax", "N1 N2  ->  N", "N is the maximum of numeric values N1 and N2.\n" },
{ "fmin", "N1 N2  ->  N", "N is the minimum of numeric values N1 and N2.\n" },
{ "fneg", "N1  ->  N2", "Float N2 is the negative of float N1.\n" },
...
{ "fsign", "N1  ->  N2", "Float N2 is the sign (-1.0 or 0.0 or 1.0) of float N1.\n" },
...
{ "get1", "->  F", "Reads a factor from input and pushes it onto stack.\n" },
...
{ ".*", "I J  ->  K", "Float K is the product of floats I and J.\n" },
{ "./", "I J  ->  K", "Float K is the ratio of floats I and J.\n" },
{ "*", "I J  ->  K", "Integer K is the product of integers I and J.\n" },
{ "/", "I J  ->  K", "Integer K is the (rounded) ratio of integers I and J.\n" },
...
{ "in_set", "X A  ->  B", "Tests whether X is a member of aggregate A.\n" },
{ "in_str", "X A  ->  B", "Tests whether X is a member of aggregate A.\n" },
...
{ "lt", "X Y  ->  B", "X and Y are strings or symbols.\nTests whether X is less than Y.\n" },
...
{ "map_set", "A [P]  ->  B", "Executes P on each member of aggregate A,\ncollects results in sametype aggregate B.\n" },
{ "map_str", "A [P]  ->  B", "Executes P on each member of aggregate A,\ncollects results in sametype aggregate B.\n" },
{ "maxint", "->  maxint", "Pushes largest integer (platform dependent). Typically it is 32 bits.\n" },
{ "max", "N1 N2  ->  N", "N is the maximum of numeric values N1 and N2.\n" },
{ "__memoryindex", "->  I", "Pushes current value of memory.\n" },
{ "__memorymax", "->  I", "Pushes value of total size of memory.\n" },
{ ".+", "M I  ->  N", "Float N is the result of adding float I to float M.\n" },
{ ".-", "M I  ->  N", "Float N is the result of subtracting float I from float M.\n" },
{ "min", "N1 N2  ->  N", "N is the minimum of numeric values N1 and N2.\n" },
...
{ "neg", "I  ->  J", "Integer J is the negative of integer I.\n" },
{ "ne", "X Y  ->  B", "X and Y are strings or symbols.\nTests whether X is not equal to Y.\n" },
{ "not_set", "X  ->  Y", "Y is the complement of set X, logical negation for truth values.\n" },
{ "not_str", "X  ->  Y", "Y is the complement of set X, logical negation for truth values.\n" },
...
{ "null_set", "X  ->  B", "Tests for empty aggregate X or zero numeric.\n" },
...
{ "of_set", "I A  ->  X", "X (= A[I]) is the I-th member of aggregate A.\n" },
{ "of_str", "I A  ->  X", "X (= A[I]) is the I-th member of aggregate A.\n" },
...
{ "primrec_int", "X [I] [C]  ->  R", "Executes I to obtain an initial value R0.\nFor integer X uses increasing positive integers to X, combines by C for new R.\nFor aggregate X uses successive members and combines by C for new R.\n" },
{ "primrec_set", "X [I] [C]  ->  R", "Executes I to obtain an initial value R0.\nFor integer X uses increasing positive integers to X, combines by C for new R.\nFor aggregate X uses successive members and combines by C for new R.\n" },
{ "primrec_str", "X [I] [C]  ->  R", "Executes I to obtain an initial value R0.\nFor integer X uses increasing positive integers to X, combines by C for new R.\nFor aggregate X uses successive members and combines by C for new R.\n" },
{ "primrec", "X [I] [C]  ->  R", "Executes I to obtain an initial value R0.\nFor integer X uses increasing positive integers to X, combines by C for new R.\nFor aggregate X uses successive members and combines by C for new R.\n" },
{ "put1", "X  ->", "Writes X to output, pops X off stack.\n" },
{ "put_bool", "X  ->", "Writes X to output, pops X off stack.\n" },
{ "putchars", "\"abc..\"  ->", "Writes abc.. (without quotes)\n" },
{ "put_char", "X  ->", "Writes X to output, pops X off stack.\n" },
...
{ "put_set", "X  ->", "Writes X to output, pops X off stack.\n" },
{ "put_str", "X  ->", "Writes X to output, pops X off stack.\n" },
{ "put_sym", "X  ->", "Writes X to output, pops X off stack.\n" },
{ "put", "X  ->", "Writes X to output, pops X off stack.\n" },
{ "quit", "->", "Exit from Joy.\n" },
{ "rand", "->  I", "I is a random integer.\n" },
{ "rem", "I J  ->  K", "Integer K is the remainder of dividing I by J.\n" },
{ "rest", "A  ->  R", "R is the non-empty aggregate A with its first member removed.\n" },
{ "rest_set", "A  ->  R", "R is the non-empty aggregate A with its first member removed.\n" },
{ "rest_str", "A  ->  R", "R is the non-empty aggregate A with its first member removed.\n" },
...
{ "size_set", "A  ->  I", "Integer I is the number of elements of aggregate A.\n" },
{ "size_str", "A  ->  I", "Integer I is the number of elements of aggregate A.\n" },
{ "small_int", "X  ->  B", "Tests whether aggregate X has 0 or 1 members, or numeric 0 or 1.\n" },
{ "small_set", "X  ->  B", "Tests whether aggregate X has 0 or 1 members, or numeric 0 or 1.\n" },
...
{ "some_set", "A [B]  ->  X", "Applies test B to members of aggregate A, X = true if some pass.\n" },
{ "some_str", "A [B]  ->  X", "Applies test B to members of aggregate A, X = true if some pass.\n" },
{ "split", "A [B]  ->  A1 A2", "Uses test B to split aggregate A into sametype aggregates A1 and A2.\n" },
{ "split_set", "A [B]  ->  A1 A2", "Uses test B to split aggregate A into sametype aggregates A1 and A2.\n" },
...
{ "step_set", "A [P]  ->  ...", "Sequentially putting members of aggregate A onto stack,\nexecutes P for each member of A.\n" },
...
{ "take_set", "A N  ->  B", "Aggregate B is the result of retaining just the first N elements of A.\n" },
{ "take_str", "A N  ->  B", "Aggregate B is the result of retaining just the first N elements of A.\n" },
...
{ "uncons_set", "A  ->  F R", "F and R are the first and the rest of non-empty aggregate A.\n" },
...
{ "unswons_set", "A  ->  R F", "R and F are the rest and the first of non-empty aggregate A.\n" },
{ "unswons_str", "A  ->  R F", "R and F are the rest and the first of non-empty aggregate A.\n" },
...
{ ".>", "X Y  ->  B", "Tests whether X is greater than Y.\n" },
{ "=", "X Y  ->  B", "X and Y are numeric.\nTests whether X is equal to Y.\n" },
{ ">=", "X Y  ->  B", "X and Y are numeric.\nTests whether X is greater than or equal to Y.\n" },
{ ">", "X Y  ->  B", "X and Y are numeric.\nTests whether X is greater than Y.\n" },
{ "<=", "X Y  ->  B", "X and Y are numeric.\nTests whether X is less than or equal to Y.\n" },
{ "<", "X Y  ->  B", "X and Y are numeric.\nTests whether X is less than Y.\n" },
